...
import health.guardian.modules.knowledgebase.repository.VectorRepository;
...
class KnowledgeBaseVectorServiceTest {
    ...
    class SimilaritySearchTests {
        ...
        void testBasicSearchWithoutFilter() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, topK, MIN_SCORE);
        ...
        void testSearchWithKnowledgeBaseIdFilterString() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, knowledgeBaseIds, topK, MIN_SCORE);
        ...
        void testTopKLimit() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, List.of(1L), topK, MIN_SCORE);
        ...
        void testSearchFailureThrowsException() {
            ...
            RuntimeException exception = assertThrows(
                RuntimeException.class,
                () -> vectorService.similaritySearch(query, null, 5, MIN_SCORE)
            );
        ...
        void testSearchWithEmptyKnowledgeBaseIdList() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, emptyList, topK, MIN_SCORE);
        ...
        void testSearchReturnsEmpty() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, 10, MIN_SCORE);
        ...
        void testFilteredResultsEmpty() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, knowledgeBaseIds, 10, MIN_SCORE);
    ...
    class EdgeCaseTests {
        ...
        void testEmptyQuery() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(emptyQuery, null, 5, MIN_SCORE);
        ...
        void testTopKZero() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, 0, MIN_SCORE);
