package health.guardian.infrastructure.file;

import health.guardian.common.config.StorageConfigProperties;
...
public class FileStorageService {
     ...
     * 上传体检报告文件
     */
    public String uploadHealthReport(MultipartFile file) {
        return uploadFile(file, "healthreports");
    }

    /**
     * 删除体检报告文件
     */
    public void deleteHealthReport(String fileKey) {
        deleteFile(fileKey);
    }
     ...
     * 上传公共文档文件
     */
    public String uploadPublicDoc(MultipartFile file) {
        return uploadFile(file, "publicdocs");
    }

    /**
     * 删除公共文档文件
     */
    public void deletePublicDoc(String fileKey) {
        deleteFile(fileKey);
    }
    ...
    private void createBucket() {
        try {
            ...
            throw new BusinessException(ErrorCode.STORAGE_UPLOAD_FAILED, "创建存储桶失败: " + e.getMessage());
        }
    }
