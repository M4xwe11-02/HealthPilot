...
import health.guardian.modules.knowledgebase.listener.VectorizeStreamProducer;
...
public class KnowledgeBaseUploadService {
    ...
    public Map<String, Object> uploadKnowledgeBase(MultipartFile file, String name, String category) {
        ...
        Optional<KnowledgeBaseEntity> existingKb = knowledgeBaseRepository.findByOwner_IdAndFileHash(
        ...
        boolean lightRagSubmitted = lightRagDocumentService.submitTextAsync(savedKb, content);
        ...
        return Map.of(
            ...
            "lightRag", Map.of(
                "submitted", lightRagSubmitted,
                "status", savedKb.getLightRagStatus() != null ? savedKb.getLightRagStatus() : "NOT_SUBMITTED"
            ),
            "duplicate", false
        );
    }
    ...
    public void revectorize(Long kbId) {
        KnowledgeBaseEntity kb = knowledgeBaseRepository.findByIdAndOwner_Id(kbId, currentUserService.requireCurrentUserId())
        ...
        lightRagDocumentService.submitTextAsync(kb, content);
