...
/**
 * 体检报告实体
 * Health Report Entity for deduplication and persistence
 */
@Entity
@Table(name = "health_reports", indexes = {
    @Index(name = "idx_health_report_owner_hash", columnList = "owner_id,fileHash", unique = true),
    @Index(name = "idx_health_report_owner_uploaded", columnList = "owner_id,uploadedAt")
})
