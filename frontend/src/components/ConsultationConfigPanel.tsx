...
interface ConsultationConfigPanelProps {
  questionCount: number;
  onQuestionCountChange: (count: number) => void;
  onStart: () => void;
  isCreating: boolean;
  checkingUnfinished: boolean;
  unfinishedSession: ConsultationSession | null;
 ...
 * 问诊配置面板组件
 */
export default function ConsultationConfigPanel({
  questionCount,
  ...
  return (
    ...
    >
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                    <h3 className="font-semibold text-amber-900 dark:text-amber-300 mb-1">检测到未完成的AI问诊</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="mb-6">
              <label
                  className="block text-sm font-semibold text-slate-600 dark:text-slate-400 mb-3">体检报告预览（前500字）</label>
              <textarea
              value={reportText.substring(0, 500) + (reportText.length > 500 ? '...' : '')}
              readOnly
            ...
            问题分布：生活方式(30%) + 营养饮食(20%) + 运动锻炼(20%) + 症状/用药/心理(20%) + 睡眠/慢性病(10%)
          </p>
