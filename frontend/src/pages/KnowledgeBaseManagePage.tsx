  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        title="健康知识库管理"
        subtitle="上传药品说明书、健康指南等知识文档，AI会基于这些文档提供专业的健康建议。"
        action={
          <div className="flex gap-2.5">
            <button
              onClick={onUpload}
              className="flex items-center gap-2 px-4 py-2 bg-primary-500 text-white rounded-xl hover:bg-primary-600 transition-colors text-sm font-medium shadow-sm shadow-primary-500/20"
            >
            ...
            <button
              onClick={onChat}
              className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-forest-700 text-slate-700 dark:text-slate-200 rounded-xl hover:bg-slate-200 dark:hover:bg-forest-600 transition-colors text-sm font-medium"
            >
          ...
          <form onSubmit={handleSearch} className="flex-1 min-w-[200px]">
            <div className="relative">
              ...
              <input
                ...
                placeholder="搜索知识库名称..."
                className="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-forest-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent bg-white dark:bg-forest-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-forest-400"
              />
            </div>
          </form>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <HardDrive className="w-16 h-16 text-slate-300 mx-auto mb-4" />
              <p className="text-slate-500 dark:text-slate-400">暂无健康知识库文档</p>
            <button
              onClick={onUpload}
          ...
          <table className="w-full">
              ...
              <tr>
                  ...
                  <th className="text-right px-6 py-4 text-xs font-semibold text-slate-500 dark:text-forest-200 uppercase tracking-wide">
                  操作
                </th>
              </tr>
            </thead>
            <tbody>
              {knowledgeBases.map((kb, index) => (
                <motion.tr
                  ...
                  className="border-b border-slate-100 dark:border-forest-700 hover:bg-slate-50 dark:hover:bg-forest-700/40 transition-colors"
                >
